...
//                     Success INTEGER NOT NULL DEFAULT 1, -- 1 for true, 0 for false
//                     StudentId INTEGER,
//                     GuardianId INTEGER,
//                     DeviceId TEXT, -- For device communication events
//                     ErrorMessage TEXT, -- For storing error details
//                     IpAddress TEXT, -- For security/network tracking
//                     UserAgent TEXT, -- For admin login tracking
...
//                 CREATE INDEX IF NOT EXISTS idx_auditlogs_success ON AuditLogs(Success);
//                 CREATE INDEX IF NOT EXISTS idx_auditlogs_studentid ON AuditLogs(StudentId);
//                 CREATE INDEX IF NOT EXISTS idx_auditlogs_guardianid ON AuditLogs(GuardianId);
